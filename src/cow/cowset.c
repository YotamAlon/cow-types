...
static PyObject *CowSet_new(PyTypeObject *t, PyObject *Py_UNUSED(a),
...
static int CowSet_init(CowSetObject *self, PyObject *args,
...
static PyObject *CowSet_richcompare(CowSetObject *self, PyObject *other,
                                    int op)
{
    PyObject *od =
        Py_IS_TYPE(other, &CowSetType) ? ((CowSetObject *)other)->data : other;
...
static PyObject *cowset_apply_op(CowSetObject *self, PyObject *other,
                                 const char *methname)
{
    PyObject *od =
        Py_IS_TYPE(other, &CowSetType) ? ((CowSetObject *)other)->data : other;
...
static PyObject *CowSet_intersection_update(CowSetObject *self,
                                            PyObject *other)
{
...
static PyObject *CowSet_symmetric_difference_update(CowSetObject *self,
                                                    PyObject *other)
{
    return cowset_apply_op(self, other, "symmetric_difference_update");
}

static PyObject *cowset_new_result(CowSetObject *self, PyObject *other,
                                   const char *methname)
{
    PyObject *od =
        Py_IS_TYPE(other, &CowSetType) ? ((CowSetObject *)other)->data : other;
...
static PyObject *CowSet_union(CowSetObject *self, PyObject *other)
{
    return cowset_new_result(self, other, "union");
}
static PyObject *CowSet_intersection(CowSetObject *self, PyObject *other)
{
    return cowset_new_result(self, other, "intersection");
}
static PyObject *CowSet_difference(CowSetObject *self, PyObject *other)
{
    return cowset_new_result(self, other, "difference");
}
static PyObject *CowSet_symmetric_difference(CowSetObject *self,
                                             PyObject *other)
{
    return cowset_new_result(self, other, "symmetric_difference");
}
...
static PyGetSetDef CowSet_getsetters[] = {{NULL}};
...
static PyMethodDef CowSet_methods[] = {
    ...
    {"intersection_update", (PyCFunction)CowSet_intersection_update, METH_O,
     NULL},
    {"difference_update", (PyCFunction)CowSet_difference_update, METH_O, NULL},
    {"symmetric_difference_update",
     (PyCFunction)CowSet_symmetric_difference_update, METH_O, NULL},
    ...
    {"symmetric_difference", (PyCFunction)CowSet_symmetric_difference, METH_O,
     NULL},
    {"copy", (PyCFunction)CowSet_copy, METH_NOARGS, NULL},
    {NULL}};

static PySequenceMethods CowSet_as_sequence = {
    (lenfunc)CowSet_length, 0, 0, 0, 0, 0, 0, (objobjproc)CowSet_contains,
};

static PyTypeObject CowSetType = {
    PyVarObject_HEAD_INIT(NULL, 0).tp_name = "cow.cowset",
